...
<%
 /**
  * @Class Name : NoticeRegister.jsp
  * @Description : Notice Register 화면
...
<c:set var="registerFlag" value="${empty noticeVO.name ? '등록' : '수정'}"/>			
...
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/notice/NoticeList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/notice/deleteNotice.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/notice/addNotice.do' : '/notice/updateNotice.do'}"/>";
    frm.submit();
...
<form:form commandName="noticeVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
