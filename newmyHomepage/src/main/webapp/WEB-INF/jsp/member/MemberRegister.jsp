...
<%
  ...
  * @Description : Member Register 화면
...
<c:set var="registerFlag" value="${empty memberVO.id ? '등록' : '수정'}"/>			
...
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/member/MemberList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/member/deleteMember.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/member/addMember.do' : '/member/updateMember.do'}"/>";
    frm.submit();
...
<form:form commandName="memberVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
