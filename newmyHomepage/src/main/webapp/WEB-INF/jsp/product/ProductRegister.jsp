...
<%
 /**
  * @Class Name : ProductRegister.jsp
  * @Description : Product Register 화면
...
<c:set var="registerFlag" value="${empty productVO.num ? '등록' : '수정'}"/>			
...
<!-- validator:javascript formName="productVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/product/ProductList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/product/deleteProduct.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/product/addProduct.do' : '/product/updateProduct.do'}"/>";
    frm.submit();
...
<form:form commandName="productVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" >
		...
		<tr>
			<th>unit</th>
			<td>
				<form:input path="unit" cssClass="txt"/>
