...
<%
 /**
  * @Class Name : ProductList.jsp
  * @Description : Product List 화면
...
function fn_egov_select(num) {
    document.getElementById("listForm").num.value = num;
   	document.getElementById("listForm").action = "<c:url value='/product/updateProductView.do'/>";
   	document.getElementById("listForm").submit();
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/product/addProductView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/product/ProductList.do'/>";
   	document.getElementById("listForm").submit();
}
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
		 				<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.num}"/>')"><c:out value="${result.num}"/></a>&nbsp;</td>
								...
								<td align="center" class="listtd"><c:out value="${result.unit}"/>&nbsp;</td>
